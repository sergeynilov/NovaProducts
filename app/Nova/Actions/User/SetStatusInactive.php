...
class SetStatusInactive extends Action
{
    ...
    public $confirmText = 'Setting user\'s status into "Inactive" you forbid the user to enter into his account and to use functionality of our site';
    ...
    public function handle(ActionFields $fields, Collection $models)
    {
        ...
        try {
            ...
            foreach ($userIds as $userId) {
                if($this->changeStatus->setInactive(userId: $userId, notes:$fields['note'])) {
                }
            }
            DB::commit();
        ...
        return ActionResponse::message('For this user status was set to inactive !');
    }
